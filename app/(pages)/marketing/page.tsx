...
import { ClientPageWrapper } from "@/components/wrapper/client-page-wrapper";
    ...
    <ClientPageWrapper>
      <div className="flex flex-col min-h-screen items-center mt-[2.5rem] p-3 w-full">
        ...
        <div className="mb-3 mt-[1.5rem] max-w-[900px] w-full">
          <VideoPlayerWrapper videoSrc="https://utfs.io/f/08b0a37f-afd7-4623-b5cc-e85184528fce-1f02.mp4" />
        </div>
